...
class  Approch2
{
	public static void main(String[] args)  throws Exception
	{
		...
		sun.jdbc.odbc.JdbcOdbcDriver  od = new 		sun.jdbc.odbc.JdbcOdbcDriver();			//1st time regster...bcoz of Static method

		//1.registerDriver with DriverManager	 ----> already regirer bcoz of static block
